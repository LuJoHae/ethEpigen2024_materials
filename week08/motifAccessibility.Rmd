...
<<<<<<< HEAD
set.seed(0) # fix random seed
=======
# ensure reproducibility
set.seed(1234)
>>>>>>> upstream/main
# for each peak, we identify similar peaks as background
bg <- chromVAR::getBackgroundPeaks(se, niterations=1000) # non-deeterministic!!!
...
dev <- chromVAR::computeDeviations(object = se, annotations=moi,
                                   background_peaks=bg)
<<<<<<< HEAD
dev #ChromVARDeviation objects inherit from SummerizedExperiments class
=======
dev
head(assay(dev))
>>>>>>> upstream/main
...
<<<<<<< HEAD
dev$condition <- factor(dev$condition) # 0th factor must be the control!!!
=======
